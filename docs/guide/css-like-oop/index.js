...
__name(this,"Adapter")}static cssProcess(css){return stylis(css)}};var Card=class extends Adapter{static{__name(this,"Card")}static{this.css=`
        display: inline-flex;
        box-sizing: border-box;
        border: 1px solid;
        border-radius: 5px;
        padding: 1rem;
    `}};Card.define("el-card");var BlueCard=class extends Card{static{__name(this,
"BlueCard")}};BlueCard.css=`
